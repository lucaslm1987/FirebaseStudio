...
import type { FormData, TeamMember } from '@/types/form';
...
export function Step1GeneralData({ formData, setFormData }: Step1GeneralDataProps) {
  ...
  const handleGetLocation = () => {
    ...
    const updateTeamMember = (name: string, field: keyof Omit<TeamMember, 'name'>, value: any) => {
        setFormData(prev => ({
            ...prev,
